...
/*   Updated: 2024/10/10 13:43:26 by tebandam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	raycast(void *param)
{
	...
	{
		game->ray_result.ray_angle = game->player->angle - (game->player->fov / 2) + i * angle_step; // calcul de l'angle du rayon actuel
